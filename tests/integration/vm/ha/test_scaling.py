...
async def test_scale_down_multiple_units(juju: jubilant.Juju, substrate: Substrate) -> None:
...
async def test_scale_to_zero_and_back(juju: jubilant.Juju, c_writes, substrate: Substrate) -> None:
